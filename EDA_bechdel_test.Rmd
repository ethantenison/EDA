...
Secuence of events:
EDA! and a breakdown about what we're going to talk about 
My background
Basics of Eda
TIDY DATA VOCAB
TidyTuesday
...
The Bechdel test is a measure of the representation of women in fiction, and it is specifically to address gender bias in film. It asks whether a work features at least two women who talk to each other about something other than a man.
...
#install.packages(c('tidyverse','tidytuesdayR', 'scales'))
...
ggplot(data = movies) +
  ...
  theme(
    ...
    text = element_text(size = 16, # Font size and face 
                        face = "bold"),
    axis.title.y = element_text( #Axis label margins 
      margin = margin(t = 0,r = 10,b = 0,l = 0)),
    axis.title.x = element_text( #Axis label margins
...
It's your turn! Select a categorical variable (in this case your only option are character variables).

```{r your_turn}


#ggplot(data = movies) +
#  geom_bar(mapping = aes(x = "Insert a column name here"))
